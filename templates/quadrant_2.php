<div class="col-xs-6" style="height: 230px; background:#FFFF66; padding: 20px;">
    <div>
    <table id="todolist">
        <tr>
            <td>
                <strong>很重要-不紧急</strong>
            </td>
            <td>
                <a href="newTask.php?quadrant=2"><img src="images/plus.png" alt="增加"></a>
            </td>
        </tr>
    </table>
    </div>
