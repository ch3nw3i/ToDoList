<div class="col-xs-6" style="height: 230px; background:#99CCFF; padding: 20px;">
    <div>
    <table id="todolist">
        <tr>
            <td>
                <strong>不重要-很紧急</strong>
            </td>
            <td>
                <a href="newTask.php?quadrant=3"><img src="images/plus.png" alt="增加"></a>
            </td>
        </tr>
    </table>
    </div>
